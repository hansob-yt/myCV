...
export const PrintResume: React.FC = () => {
  return (
    <div className="hidden print:block max-w-4xl mx-auto bg-white text-slate-900 font-sans leading-normal">
      
      {/* PAGE 1 CONTENT */}
      <div>
        {/* Resume Top Header */}
        <div className="border-b-2 border-slate-900 pb-3.5 mb-5">
          <div className="flex justify-between items-start gap-6">
            ...
            <div className="text-xs font-mono text-slate-800 space-y-1 text-right whitespace-nowrap shrink-0">
              <div>
        ...
        <section className="mb-5 resume-section">
          <h2 className="text-sm font-bold uppercase tracking-wider text-slate-950 border-b-2 border-slate-900 pb-1 mb-2">
            Professional Summary &amp; Bio
          </h2>
        ...
        <section className="resume-section">
          <h2 className="text-sm font-bold uppercase tracking-wider text-slate-950 border-b-2 border-slate-900 pb-1 mb-3">
          ...
          <div className="space-y-4">
            {experiences.map((exp) => (
              <div key={exp.id} className="resume-item">
                ...
                <p className="text-xs text-slate-700 mt-0.5 italic leading-normal">
                  {exp.summary}
                </p>
                <ul className="list-disc list-inside text-xs text-slate-800 mt-1.5 space-y-1 pl-1 leading-relaxed">
                  {exp.accomplishments.map((acc, rIdx) => (
                    <li key={rIdx}>{acc}</li>
                  ))}
                </ul>
                <div className="text-[11px] font-mono text-slate-700 mt-1.5">
      ...
      {/* PAGE 2 CONTENT (Clean break onto Page 2) */}
      <div className="page-break pt-2">
        ...
        <section className="resume-section">
          ...
          <div className="grid grid-cols-2 gap-3.5 text-xs text-slate-800 leading-relaxed">
            <div>
