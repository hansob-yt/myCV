    ...
    <section id="extras" className="py-20 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono font-medium bg-linear-to-r from-sky-500/10 to-indigo-500/10 text-sky-600 dark:text-sky-400 border border-sky-500/20 mb-3">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-2">
            Explore advanced tools, real code architecture snippets,
            downloadable resume layouts, Day/Night modes, and custom background
            atmospheres.
          </p>
        </div>
                ...
                {isTheme ? (
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex-1 py-2.5 px-4 rounded-xl text-xs sm:text-sm font-semibold text-white bg-linear-to-r from-sky-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 shadow-md shadow-sky-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
