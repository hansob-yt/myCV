          ...
          {experiences.map((exp) => {
            ...
            return (
              ...
              >
                ...
                {/* Minimalist Card */}
                <div className="glass-card glass-card-hover rounded-2xl p-5 sm:p-7 border border-slate-200/80 dark:border-slate-800/80 shadow-md flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">
                      {exp.techStack.slice(0, 5).map((tech, tIdx) => (
                        <span
                          key={tIdx}
                          className="px-2 py-0.5 rounded-md text-[11px] font-mono bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700/60"
                        >
                          {tech}
                        </span>
                      ))}
