    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-medium glass-card border-slate-200/80 dark:border-slate-800/80 shadow-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <div className="w-full flex flex-col gap-2 pt-2 border-t border-slate-200/80 dark:border-slate-800/80">
                ...
                <a
                  ...
                  className="flex items-center justify-between p-2 rounded-xl bg-slate-100/70 dark:bg-slate-800/50 border border-slate-200/60 dark:border-slate-700/50 text-xs text-slate-700 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition-all group/link"
                >
            ...
            <div className="lg:col-span-8 flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-lg sm:text-xl font-medium text-slate-800 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-200/80 dark:border-slate-800/80">
                ...
                <a
                  href="#projects"
                  className="px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700/70 transition-all flex items-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs sm:text-sm font-mono font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-sky-500/10 hover:text-sky-500 border border-slate-200 dark:border-slate-700/70 transition-all flex items-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="p-2.5 rounded-xl text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all ml-auto cursor-pointer"
