    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-2 shrink-0">
          ...
          {/* Day / Night Mode Switcher Button (Fixed width & height to prevent layout shifting) */}
          <button
            onClick={toggleMode}
          ...
          {/* Atmosphere Background Palette Switcher (Locked width to prevent shifting when theme name length changes) */}
          <button
        ...
        {/* Mobile Menu Buttons (Fixed dimensions) */}
